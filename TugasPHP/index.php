...
<body>
    <header>
        <div class="d-flex justify-content-center" style="background-color: #2010b1;">
            <h1 style="color: #ffffff;">Sistem informasi akademik</h1>
        </div>
        <!-- Navbar -->
    ...
    <main>
        ...
        <div class="container">
            <div class="card mt-5">
                <div class="card-header text-light, d-flex justify-content-center" style="background-color: #2010b1; color: #ffffff;" id="mahasiswa">Input Data
                    Mahasiswa</div>
                <div class="card-body">
                    <form method="post" action="proses_mahasiswa.php">
                        ...
                        <button type="submit" class="btn text-light mt-4" name="simpan"
                            style="background-color: #00ff6e;">Simpan</button>
                    </form>
                </div>
            </div>
            ...
            <!-- Mahasiswa Output -->
            <div class="card mt-5">
                <div class="card-header text-light, d-flex justify-content-center" style="background-color: #2010b1; color: #ffffff;">Data Mahasiswa</div>
                <div class="card-body">
        ...
        <div class="container">
            <div class="card mt-5">
                <div class="card-header text-light, d-flex justify-content-center" style="background-color: #2010b1; color: #ffffff;" id="wali">Input Data Wali
                    Mahasiswa</div>
                <div class="card-body">
            ...
            <div class="card mt-5">
                <div class="card-header text-light, d-flex justify-content-center" style="background-color: #2010b1; color: #ffffff;">Data Wali Mahasiswa</div>
                <div class="card-body">
                    <table class="table table-bordered">
                        <tr>
                            <th>Nomor</th>
        ...
        <div class="container">
            <div class="card mt-5">
                <div class="card-header text-light, d-flex justify-content-center" style="background-color: #2010b1; color: #ffffff;" id="admin">Input Data Admin</div>
                <div class="card-body">
        ...
        <!-- Admin Output -->
        <div class="card mt-5">
                <div class="card-header text-light, d-flex justify-content-center" style="background-color: #2010b1; color: #ffffff;">Data Admin</div>
                <div class="card-body">
                    <table class="table table-bordered">
                        <tr>
                            <th>Nomor</th>
    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class=" text-center">
                ...
                <p>@Copyright 2023 Calvin Novalingga Anggoro</p>
            </div>
        </div>
    </footer>
